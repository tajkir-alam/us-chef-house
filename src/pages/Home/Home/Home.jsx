    ...
    return (
        <div>
            ...
            <section className='my-0 py-24'>
                <div className='text-center w-3/4 lg:w-2/4 mx-auto'>
                    <h2 className='text-3xl lg:text-5xl'>Meet Our Expert Chef's</h2>
            ...
            <section className='custom-container mt-8 '>
                <div className='text-center w-3/4 lg:w-2/4 mx-auto'>
                    <h2 className='text-3xl lg:text-5xl'>You Want To Be A Chef ?</h2>
                    <div className='border border-slate-300 w-2/4 mx-auto mt-8 mb-5'></div>
                    <p className='lg:font-semibold text-slate-500'>In a great classroom, opportunities come knocking at your door.</p>
                    <p className='lg:font-bold text-md mt-2 text-slate-400'>Our Curriculum</p>
                </div>
            ...
            <section className='px-2 lg:custom-container mt-8 lg:mt-28'>
                <div className='text-center w-3/4 lg:w-2/4 mx-auto'>
                    <h2 className='text-3xl lg:text-5xl'>Who We Are ?</h2>
                    <div className='border border-yellow-400 w-2/4 mx-auto mt-6 mb-5'></div>
                </div>

                <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-5 lg:mt-16">
                    ...
                    <div>
                        <p className='lg:font-bold text-xl text-center mt-8 text-slate-500'>
