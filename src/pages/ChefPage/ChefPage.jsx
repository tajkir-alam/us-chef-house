            ...
            <div className="px-4 md:custom-container flex flex-col-reverse items-center md:grid md:grid-cols-2 gap-5 bg-[#b4b9e9] py-24">
                ...
                <div className='md:w-4/5 text-white'>
                    ...
                    <div className='mt-8 flex justify-between'>
                        <p className='text-xl font-semibold text-yellow-200 px-1 py-4 text-center'>Numbers of recipe: {num_of_recipes}</p>
                        <p className='text-xl font-semibold text-yellow-200 px-1 py-4 text-center'>Years of experience: {years_of_experience}</p>
                    </div>
