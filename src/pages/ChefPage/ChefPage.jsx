...
const ChefPage = () => {
    ...
    return (
        <>
            <section>
                <div className="px-4 lg:custom-container flex flex-col-reverse items-center lg:grid lg:grid-cols-2 gap-5 bg-[#b4b9e9] py-24">
                    ...
                    <div className='lg:w-4/5 text-white'>
                        <h2 className='text-6xl text-center font-bold tracking-wider underline'>
                            {name}
                        </h2>
                        <p className='lg:font-semibold text-md tracking-wider text-center mt-8 text-[#fffffff3] shadow-lg shadow-[#ffffffaf] px-4 py-5 rounded-2xl'>
            ...
            <div className='px-4 lg:custom-container grid gap-6 my-6'>
                {
