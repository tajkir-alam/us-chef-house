...
const Footer = () => {
    return (
        <footer className='bg-slate-800'>
            {/* <div className='my-[calc(70vh-85px)]'> */}
            <div className='lg:w-4/5 mx-auto py-8 px-2 lg:px-0'>
                <div className='text-white grid lg:grid-cols-5 gap-4 px-2'>
                    <div>
                        ...
                        <img src="https://i.ibb.co/Fw6wcGN/social-icons.png" alt="" className='hidden lg:block' />
                    </div>
                    ...
                    <div>
                        ...
                        <img src="https://i.ibb.co/Fw6wcGN/social-icons.png" alt="" className='block lg:hidden mt-5' />
                    </div>
                </div>
                ...
                <div className='flex flex-wrap-reverse gap-3 justify-between'>
                    <h1 className='text-[#b3b2b2]'>@2023 <span className='font-bold'>USChefHouse</span>. All Rights Reserved</h1>
